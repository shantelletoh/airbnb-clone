    ...
    <div className="ml-5">
      ...
      <div>
        ...
        <div className="flex mt-1.5 items-center">
          ...
          <p className="pl-2">Free Parking Spot</p>
        </div>
        <div className="flex mt-1.5 items-center">
          <input
            className="w-5 h-5"
        ...
        <div className="flex mt-1.5 items-center">
          ...
          <p className="pl-2">Pets Allowed</p>
        </div>
        <div className="flex mt-1.5 items-center">
          <input
            className="w-5 h-5"
          ...
          <p className="pl-2">Private Entrance</p>
        </div>
      </div>
    </div>
  );
